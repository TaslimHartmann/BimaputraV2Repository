...
namespace BlogPost
{
    ...
    partial void DeleteTerritory(Territory instance);
		...
		public NorthwindDataContext() : 
				base(global::BlogPost.Properties.Settings.Default.NorthwindConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPhoneChanging(string value);
    partial void OnPhoneChanged();
    partial void OnShipperTypeChanging(int value);
    partial void OnShipperTypeChanged();
    ...
    partial void OnExtraInformationChanged();
		...
		[Column(Storage="_ShipperType", DbType="Int NOT NULL")]
		public int ShipperType
		{
			get
			{
				return this._ShipperType;
			}
			set
			{
				if ((this._ShipperType != value))
				{
					this.OnShipperTypeChanging(value);
					this.SendPropertyChanging();
					this._ShipperType = value;
					this.SendPropertyChanged("ShipperType");
					this.OnShipperTypeChanged();
				}
			}
		}
		
		[Column(Storage="_ExtraInformation", DbType="NVarChar(50)")]
