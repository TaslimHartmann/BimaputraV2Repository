...
{
    /// <summary>
    /// Interaction logic for LapPengiriman.xaml
    /// </summary>
    public partial class LapPengiriman
    {
        ...
        public LapPengiriman()
        {
            InitializeComponent();
            _bpdmhContext = new DCBPDMHDataContext();
        }

        private void PengirimanReport_OnLoaded(object sender, RoutedEventArgs e)
        {
            GetCabangLookup();
        ...
        private void BtnCetak_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            dlg.FileName = "LaporanPengiriman_" + DateTime.Now.ToString(format, CultureInfo.CreateSpecificCulture("id-ID"));
            dlg.DefaultExt = ".text";
        ...
        private void PrintToExcel(string fileName)
        {
            ...
            xlWorkSheet.Cells[1, 1] = "LAPORAN PENGIRIMAN";
        ...
        private List<Model.KbhPengiriman> GetLaporanPengirimanList()
        {
            ...
            if (CboCabang.SelectedItem != null && TglPicker.SelectedDate != null && TglPicker2.SelectedDate != null)
                ...
                thResult = _bpdmhContext.GetTransaksiH()
                    .Where(c => c.CabangId == CboCabang.SelectedValue.ToString()
                    && c.TglInput == TglPicker.SelectedDate)
                    .OrderBy(c => c.TglInput).ThenBy(c => c.NoSeri);
